...
export const maintenanceContent: ServicePageContent = {
  ...
  servicesSection: {
    ...
    description:
      'We handle lawns, hedges, ongoing garden care, and seasonal tidy-ups with attention to detail' +
      'and respect for how gardens grow and change.',
    buttons: [
      { id: 'lawn-care', label: 'Lawn Care' },
      { id: 'hedge-trimming', label: 'Hedge Trimming' },
      { id: 'garden-maintenance', label: 'Ongoing Maintenance' },
